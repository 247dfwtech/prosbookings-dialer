...
async function createCall(opts) {
  ...
  const body = {
    ...
    assistantOverrides: {
      ...
      metadata: {
        ...
        dialerId: opts.dialerId ?? '',
        isRetry: !!opts.isRetry,
        hasVoicemail: !!(opts.voicemailMessage && String(opts.voicemailMessage).trim()),
      },
    },
  };
  ...
  console.log('[vapi] createCall:', { to: e164, externalId: body.customer.externalId, assistantId: body.assistantId });
